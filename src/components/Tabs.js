  ...
  return (
    <TabsWrapper>
      <div className='tabs'>
        ...
        <div>
            <h1>Expand your career opportunities with range of courses</h1>
            
            <p>Take one of Udemy’s range of courses and learn how to code using these incredibly useful languages.
            Courses simple syntax and readability makes any language perfect for learning.
            You’ll learn how to build everything from games to sites to apps. Choose from a range of courses that
            will appeal to...</p>
        </div>
